...
import { cn } from "@/app/lib/util/frontend/shadcn-utils";

const buttonVariants = cva("inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none ...", {
	variants: {
		variant: {
			...
			coralBtn: "rounded-md bg-[#FBF7F0] px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-[#FBF7F0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FBF7F0] capitalize flex justify-center items-center",
			peachBtn: "rounded-md bg-[#FFB27D] px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-orange-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFB27D] capitalize flex justify-center items-center",
			slateBlueBtn: "rounded-md bg-[#4C6EF5] px-3.5 py-2.5 text-sm font-semibold text-white hover:text-gray-900 shadow-sm hover:bg-blue-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4C6EF5] capitalize flex justify-center items-center",
