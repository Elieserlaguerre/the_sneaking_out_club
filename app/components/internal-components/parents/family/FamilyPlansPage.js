			...
			<div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 min-h-screen flex flex-col">
				...
				<header>
					<div className={classNames(theme.base, "px-4 py-16 text-center sm:px-6 lg:px-8")}>
						<h1 className={classNames("text-4xl font-bold tracking-tight capitalize text-white")}>family plans</h1>
						<p className={classNames("mx-auto mt-4 max-w-xl text-base text-white")}>create, delete, track and manage family plans all in one place.</p>
					</div>
