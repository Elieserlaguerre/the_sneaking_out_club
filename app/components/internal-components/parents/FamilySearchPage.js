			...
			<div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 min-h-screen flex flex-col">
				...
				<header>
					<div className={classNames(theme.base, "px-4 py-16 text-center sm:px-6 lg:px-8 bg-linear-to-br from-blue-500 to-blue-700")}>
						<h1 className={classNames("text-4xl font-bold tracking-tight capitalize text-white")}>family search</h1>
						<p className={classNames("mx-auto mt-4 max-w-xl text-base text-white")}>search for your family members across the platform.</p>
					</div>
